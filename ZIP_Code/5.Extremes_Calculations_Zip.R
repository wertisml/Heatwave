...
Heatwave <- fread("C:\\Users\\owner\\Documents\\GRAM\\HeatWave\\Data\\NC_Heatwave_ML.csv")
#==============================================================================#
...
Heatwave$Zip <- as.character(Heatwave$Zip)
...
Heat_Year <- Heatwave %>%
  ...
  select(Date, Zip, No_Heatwave, Heatwave_days, Severe_Heatwaves, Extreme_Heatwaves, Above_95th, Above_97th, Above_99th,
         ...
         RH, Heat_Index, Discomfort_Index)

#==============================================================================#
#write to .csv
#==============================================================================#

fwrite(Hot_Yearly_Data, "Hot_Yearly_Data.csv")    
fwrite(Hot_County_Data, "Hot_County_Data.csv") 
fwrite(Heat_Year, "Heatwave_For_ML.csv")
